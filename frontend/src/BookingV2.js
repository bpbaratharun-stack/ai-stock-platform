    ...
    <div className="pf" data-pf-theme={theme}>
      ...
      <div className="wrap">
        <header className="top">
          <div className="brand">
            <h1>Portfolio</h1>
            <nav className="nav"><Link to="/v2">Overview</Link><Link className="on" to="/v2/booked">Booking</Link></nav>
          </div>
          <div className="controls">
            ...
            <Link className="icon" to="/booked" title="Classic view">Classic</Link>
          </div>
        </header>
        {body}
